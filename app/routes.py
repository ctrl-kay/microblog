from flask import render_template, flash, redirect, url_for, request #import render template function
from werkzeug.urls import url_parse
from app import app, db
from app.forms import LoginForm, RegistrationForm # import LoginForm class from app.forms module
